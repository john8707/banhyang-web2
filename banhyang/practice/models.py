...
class KakaoTalkId(models.Model):
    ...
    user_id = models.ForeignKey(User, on_delete=models.CASCADE, related_name='kakaotalkid')


class ArrivalTime(models.Model):
    id = models.AutoField(primary_key=True)
    user_id = models.ForeignKey(User, on_delete=models.CASCADE, related_name='arrivaltime')
